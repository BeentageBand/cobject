...
typedef int (*Class_Compare_T)(union Object const *const,
                               union Object const *const);
...
extern void Object_populate(union Object *const object,
                            struct Class *const clazz);

extern union Object *Object_cast(union Object *const object,
                                 struct Class *const target_class);

extern void Object_delete(union Object *const object);

extern int Object_compare(union Object const *const object,
                          union Object const *const other);

extern void Object_copy(union Object *const object,
...
#define _cast(obj, clazz)                                                      \
  (union clazz *)Object_cast(&(obj)->Object, &Get_##clazz##_Class()->Class)
...
#define _equals(lval, rval)                                                    \
  (0 == Object_compare(&(lval)->Object, &(rval)->Object))
